...
class LegacyWordGenerator {
    ...
    private String getNextCharacter(int type, int mainIndex) {
        return itemFrom(NEXT_CHAR_LOOKUP[mainIndex][type]);
    }
