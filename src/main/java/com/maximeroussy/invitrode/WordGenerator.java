...
class WordGenerator {
    ...
    // Visible for testing
    String generateWord2(WordLength wordLength) {
    ...
    private boolean isBigram(String currentWord) {
        return currentWord.length() == 2;
    }

    private boolean oneCharacterLeft(WordLength desiredLength, String currentWord) {
        return currentWord.length() == (desiredLength.wordLength - 1);
    }


    private boolean isUnknownBigram(String bigram) {
    ...
    private boolean noPossibleNextCharacter(String currentWord, boolean lastCharacter) {
    ...
    private static String[][] nextPronounceableCharactersLists(String currentWord) {
        ...
        int i = bigramIndex(lastBigram);
        return PRONOUNCEABLE_NEXT_CHARACTERS[i];
    }
    
    private static String lastBigram(String theWord) {
        return theWord.substring(theWord.length() - 2);
    }
